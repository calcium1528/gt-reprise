...
Every human SOUL naturally contains a mixture of all base traits, with the dominant trait(s) taking the majority and defining what the user's magical suite is.

### Determination
Determination is driven by willpower and hope.<br>
It is the hardest trait to develop and make dominant out of all seven. It is generally regarded as the most powerful trait, though that does not mean it can't be defeated at all.
...
- Physical Bravery makes a person resillient to physical difficulties in general, whether that'd be exhaustion, pain, injuries, and even death.
- Moral Bravery lets one act correctly despite the humiliation, dishonor, or rejection that follows afterward.

People with Bravery usually have these aspects balanced, but in rare cases, one can be skewed towards either two.<br>
